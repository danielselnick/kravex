...
const THE_SACRED_VICTORY_SCROLLS: &[&str] = &[
    // -- 👨 Dad jokes
    "🎉 MIGRATION COMPLETE in {elapsed}! I told my wife I was migrating data. She asked when we're moving. I said 'the data, Karen.'",
    ...
    "🎉 MIGRATION COMPLETE in {elapsed}! I used to hate data migration... but then it grew on me. Like mold. On legacy systems.",
    "🎉 MIGRATION COMPLETE in {elapsed}! What do you call a search index that won't move? Stuck in its ways. Like my father-in-law.",
    ...
    "🎉 MIGRATION COMPLETE in {elapsed}! I don't dream of electric sheep. I dream of unacknowledged bulk requests.",
    ...
    "🎉 MIGRATION COMPLETE in {elapsed}! Zero unsafe blocks were harmed in this migration. The borrow checker sends its regards.",
    "🎉 MIGRATION COMPLETE in {elapsed}! Lifetime annotations? Checked. Data? Migrated. Hotel? Trivago. Borrow checker? Appeased.",
    ...
    "🎉 MIGRATION COMPLETE in {elapsed}! I mass-moved your data faster than mass layoffs move engineers. Too soon?",
    ...
    "🎉 MIGRATION COMPLETE in {elapsed}! Per my last email, the deliverables have been actioned. Please see attached: your data.",
    "🎉 MIGRATION COMPLETE in {elapsed}! Let's circle back on this win and leverage our learnings going forward. Namaste.",
    "🎉 MIGRATION COMPLETE in {elapsed}! The migration was completed with zero alignment gaps and full stakeholder buy-in from the bytes.",
    // -- 💅 Gen Z slang
    "🎉 MIGRATION COMPLETE in {elapsed}! no cap this migration slapped fr fr. the data is giving ✨moved✨ energy.",
    "🎉 MIGRATION COMPLETE in {elapsed}! that migration was lowkey bussin. your indices? understood the assignment.",
    "🎉 MIGRATION COMPLETE in {elapsed}! slay. the source cluster is ghosted. the sink cluster is the main character now.",
    "🎉 MIGRATION COMPLETE in {elapsed}! it's giving ✨zero data loss✨. periodt.",
    // -- 🎭 Seinfeld-style observations
    "🎉 MIGRATION COMPLETE in {elapsed}! What's the DEAL with data migrations? You take the data, you move it. That's the whole show!",
    "🎉 MIGRATION COMPLETE in {elapsed}! You know what I don't understand? Index mappings. Nobody understands index mappings. It's like a phone book written by aliens.",
    ...
    "🎉 MIGRATION COMPLETE in {elapsed}! The wise engineer tests in staging. The brave engineer tests in production. We are brave. — Sun Tzu",
    "🎉 MIGRATION COMPLETE in {elapsed}! To migrate is human. To migrate without data loss is divine. — Alexander Pope's SRE handbook",
    ...
    "🎉 MIGRATION COMPLETE in {elapsed}! This message was randomly selected from 50+ options. You're special. This moment is special.",
    "🎉 MIGRATION COMPLETE in {elapsed}! Plot twist: the data was inside you all along. Just kidding, it's in the sink cluster now.",
    "🎉 MIGRATION COMPLETE in {elapsed}! Fun fact: you'll see a different message next time. Or this one again. Chaos is a feature.",
    // -- 🕵️ Conspiracy theories
    "🎉 MIGRATION COMPLETE in {elapsed}! The borrow checker is sentient. I have proof. It let this migration complete on purpose.",
    "🎉 MIGRATION COMPLETE in {elapsed}! They don't want you to know this, but the documents in search clusters are free. You can just take them.",
    "🎉 MIGRATION COMPLETE in {elapsed}! Area 51 called. They want their data back. We told them it's in OpenSearch now.",
    // -- 🎬 Movie/TV quotes
    "🎉 MIGRATION COMPLETE in {elapsed}! 'I'm gonna make him an offer he can't refuse' — this crate, to your sink cluster",
    "🎉 MIGRATION COMPLETE in {elapsed}! 'To infinity and beyond!' — your documents, leaving the source cluster",
    "🎉 MIGRATION COMPLETE in {elapsed}! 'After all, tomorrow is another migration.' — Scarlett O'Hara, DevOps Engineer",
    ...
    "🎉 MIGRATION COMPLETE in {elapsed}! 'That's one small step for data, one giant leap for your search cluster.' — Neil Ruststrong",
    // -- 👴 Boomer tech confusion
    "🎉 MIGRATION COMPLETE in {elapsed}! This is like a fax machine but for bytes. And faster. And nobody jams.",
    "🎉 MIGRATION COMPLETE in {elapsed}! Back in my day, we migrated data with SCP and prayer. Kids these days with their 'pipelines.'",
    "🎉 MIGRATION COMPLETE in {elapsed}! My manager asked if I could just copy-paste the data. I said yes. This is the paste.",
    // -- 🏭 Enterprise satire
    "🎉 MIGRATION COMPLETE in {elapsed}! com.kravex.enterprise.migration.completion.handler.factory.AbstractVictoryLapImpl says: done.",
    "🎉 MIGRATION COMPLETE in {elapsed}! This migration was approved by 7 committees, 3 architecture review boards, and 1 Rust crate.",
    ...
    // -- 🎤 Knock-knock aftermath
    "🎉 MIGRATION COMPLETE in {elapsed}! Knock knock. Race condition. Who's th— MIGRATION COMPLETE!",
    "🎉 MIGRATION COMPLETE in {elapsed}! Knock knock. Who's there? 200 OK. 200 OK who? 200 OK your data is migrated.",
    // -- 🐸 Memes
    "🎉 MIGRATION COMPLETE in {elapsed}! (Dog in fire) This is fine. Except it actually IS fine this time. Weird.",
    "🎉 MIGRATION COMPLETE in {elapsed}! ← This is the way. The Mandalorian was right about data migration all along.",
    ...
    "🎉 MIGRATION COMPLETE in {elapsed}! The singularity will happen before the next major Elasticsearch breaking change. Probably.",
    "🎉 MIGRATION COMPLETE in {elapsed}! In the grand cosmic timeline, this migration was instantaneous. In wall-clock time, it was {elapsed}.",
    // -- 🎲 Satire
    ...
    "🎉 MIGRATION COMPLETE in {elapsed}! Your data has been migrated with artisanal, hand-crafted, small-batch, locally-sourced Rust code.",
...
mod tests {
    ...
    fn the_one_where_we_have_enough_variety() {
        assert!(
            THE_SACRED_VICTORY_SCROLLS.len() >= 50,
            "🎯 We need at least 50 victory messages, got {}. The comedy density gods demand more.",
